...
RUNS_TO_LOAD = get_runs_by_model_tags(
    ...
    {
        'DRVI': 'pbmc_covid_comparison_analysis_64__DRVI',
        'PCA': 'pbmc_covid_comparison_analysis_64__PCA',
        'ICA': 'pbmc_covid_comparison_analysis_64__ICA',
        'LIGER': 'pbmc_covid_comparison_analysis_64__LIGER',
        'MOFA': 'pbmc_covid_comparison_analysis_64__MOFA',
        'scETM': 'pbmc_covid_comparison_analysis_64__scETM',
    },
)
