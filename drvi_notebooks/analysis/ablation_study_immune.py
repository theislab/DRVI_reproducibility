...
disentanglement_results_df = pd.read_csv(proj_dir / 'results' / f'eval_disentanglement_immune_hvg_ablation_all.csv', index_col=0)
...
methods_to_consider = ["DRVI", "DRVI-AP", "scVI", "PCA", "ICA", "MICHIGAN", "B-TCVAE", "MOFA", "LIGER", "scETM"]
