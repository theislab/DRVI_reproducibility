...
RUNS_TO_LOAD = get_runs_by_model_tags(
    ...
    {
        'DRVI': 'Immune_comparison_analysis_128__DRVI',
        'PCA': 'Immune_comparison_analysis_128__PCA',
        'ICA': 'Immune_comparison_analysis_128__ICA',
        'LIGER': 'Immune_comparison_analysis_128__LIGER',
        'MOFA': 'Immune_comparison_analysis_128__MOFA',
        'scETM': 'Immune_comparison_analysis_128__scETM',
    },
)
